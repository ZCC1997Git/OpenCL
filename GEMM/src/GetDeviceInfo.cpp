...
{
    cl_uint result;
    clGetDeviceInfo(id, CL_DEVICE_MAX_COMPUTE_UNITS, sizeof(cl_uint), &result, nullptr);
    return result;
}
...
{
    cl_uint result;
    clGetDeviceInfo(id, CL_DEVICE_MAX_CLOCK_FREQUENCY, sizeof(cl_uint), &result, nullptr);
    return result;
}
...
{
    cl_ulong result;
    clGetDeviceInfo(id, CL_DEVICE_GLOBAL_MEM_SIZE, sizeof(cl_ulong), &result, nullptr);
    return result;
}
...
std::string GetDeviceVersion(cl_device_id id)
{
    ...
    std::string result;
    result.resize(size);
    clGetDeviceInfo(id, CL_DEVICE_VERSION, size, const_cast<char *>(result.data()), nullptr);
    return result;
}
...
{
    cl_uint result;
    clGetDeviceInfo(id, CL_DEVICE_GLOBAL_MEM_CACHELINE_SIZE, sizeof(cl_uint), &result, nullptr);
    return result;
}
...
{
    cl_bool result;
    clGetDeviceInfo(id, CL_DEVICE_DOUBLE_FP_CONFIG, sizeof(cl_bool), &result, nullptr);
    return result;
}
...
{
    cl_uint result;
    clGetDeviceInfo(id, CL_DEVICE_NATIVE_VECTOR_WIDTH_FLOAT, sizeof(cl_uint), &result, nullptr);
    return result;
}